...
### Requirement: 主题切换按钮在导航栏可见

系统 SHALL 在导航栏右侧（登录按钮/用户头像左侧）渲染一个主题切换按钮，图标随当前主题变化（深色显示太阳 ☀️，浅色显示月亮 🌙）。
...
### Requirement: 主题切换不影响 Clerk 认证页面
