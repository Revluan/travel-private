...
import { Check, Search, ArrowLeftRight, Wrench, Loader2, AlertCircle, MapPin, Sparkles, Navigation, Info, ChevronDown } from "lucide-react";
      ...
      return (
        <Collapsible defaultOpen={true}>
          <div className="rounded-lg border border-blue-700/40 bg-blue-800/10 p-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
            {/* Day header */}
            <CollapsibleTrigger className="flex items-center gap-2 w-full text-left cursor-pointer group mb-3">
              ...
              <ChevronDown className="h-4 w-4 text-zinc-500 shrink-0 transition-transform duration-200 group-aria-expanded:rotate-0 -rotate-90" />
            </CollapsibleTrigger>
